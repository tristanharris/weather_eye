...
module WeatherEye
  ...
  class Sample
    ATTRS = [:time, :humidity_in, :temp_in, :humidity_out, :temp_out, :pressure,
    ...
    def self.from_raw(raw)
      ...
      data[:wind_speed] = (raw[11] & 0x0f << 4) + raw[9]
      data[:gust_speed] = (raw[11] & 0xf0 << 8) + raw[10]
      ...
      data[:pressure] = nil if data[:directionressure] == 0xffff
